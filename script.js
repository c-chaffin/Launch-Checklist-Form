...
window.addEventListener("load", function() {
   ...
   form.addEventListener("submit", function(event) {
      ...
      if ((pilotInput.value === '')|| (copilotInput.value === '')||(fuelLevelInput.value === '') || (cargoMassInput.value === '')) {
         ...
         alert("Please enter valid name for Pilot Name");
         event.preventDefault();
      } else if (isNaN(copilotInput.value) === false) {
         alert("Please enter valid name for Co-pilot Name");
         event.preventDefault();
      }  else if (isNaN(fuelLevelInput.value) === true) {
         alert("Please enter valid number for Fuel Level (L)");
         event.preventDefault();
      } else if (isNaN(cargoMassInput.value) === true) {
         alert("Please enter a valid number for Cargo Mass (kg)")
         event.preventDefault();
      } else {
